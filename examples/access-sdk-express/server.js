...
export function buildServer(opts = {}) {
  const useRealAttest = opts.realMode === true;
  ...
  const accessConfig = {
    insumerApiKey: useRealAttest
      ? (opts.insumerApiKey ?? process.env.INSUMER_API_KEY ?? '')
      : 'dev-key-not-used-in-mock-mode',
    collections: {
      default: {
        address: opts.collectionAddress ?? '0x3E2a408cc6eceba04FF9d04A5B8B05aBa8DD50ce',
        chain: 'base',
      },
    },
